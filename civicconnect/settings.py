"""
Django settings for civicconnect project.
...
SECRET_KEY = 'f#8q=zo(h1ku8nsvr=dv-j#&)it3e*e3$5s)-i#4qi+mh(-mu2'
...
SITE_ID = 4 # Not sure why, but the site id in the database is 2
